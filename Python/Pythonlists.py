...
<meta name="google-site-verification" content="uTcBu73vIPkcKt7JSEQDpHe9Y3Sb0QyV2jL2P6KoNpI" />
<meta name="verify-admitad" content="fb09364f2b" />
    ...
    <link rel="stylesheet" href="/public/css/onlinegdb.css?v=11" />
    
    
    <script>  var main_ide =  true;  </script>
    
    
    <script type="text/javascript" src="/public/js/onlinegdb.js?v=2"></script>
    ...
    <script type="text/javascript" src="/public/js/editor.js?v=1" defer></script>
    <script type="text/javascript" src="/public/js/main.js?v=25" defer></script>
    ...
    <div class="split-pane-component " id="left-component" style="background-color: #125792;">
        <div style="background-color: #125792; padding:10px 0px 0px 0px">
          ...
          <div style="text-align: center;    color: #ccd7dd;    padding: 10px 0px;    font-style: italic;    border-top: 1px solid #658a9e;    border-bottom: 1px solid #658a9e;">
              ...
              Welcome, <a href="/profile/" style="color:white; font-size:inherit"><b>Abena Apaw</b></a>
          ...
          <ul class="nav nav-tabs nav-stacked text-center" style="background-color: #337ab7; border-bottom:1px solid #658a9e">
                ...
                <li id="navbar-ide"><a href="/">Create New Project</a></li>
...
<center>
    ...
    <script type="text/javascript">var do_fallback_ad_check = false;</script>
...
<span style="float:none;clear:both">&copy; 2016 - 2019 GDB Online</span>
</div>
        </footer>
    ...
    <div id="title-bar" style="padding:0px 5px;min-width:900px">
        ...
        <div style="position:relative">
            ...
            <span class="col-sm-63" id="control-bar" style="float:left">
                ...
                <button type="button" id="control-btn-newfile" class="btn btn-default" data-placement="right" data-toggle="tooltip" title="New File (Ctrl + M)"><span class="glyphicon glyphicon-file"></span></button>
    ...
    <div id="multi_editor_container">
        <div style="clear:both; background-color:#757575;">
            <ul class="editor_file_tabs nav nav-pills">
                    ...
                    <li class="active">
                        <a href="#editor_1" data-toggle="tab"><span class="filename">source code</span>                   
                        </a>
                    </li>
        ...
        <div class="editor_text_panes tab-content clearfix">
            ...
            <div id="editor_1" class="tab-pane active editor" 
...
<div class="panel panel-default">
    ...
    <div class="panel-group">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4 class="panel-title">
                    <a data-toggle="collapse" class="collapse-toggle" href="#comment_box">Comments</a>
                </h4>
            </div>
...
<script>
  ...
  //ga('set', 'userId', '1328141'); // Set the user ID using signed-in user_id.
  ga('create', 'UA-79897653-2', 'auto', {userId: '1328141' });
...
<a href="#" onclick="hide_tawkto()"><span class="glyphicon glyphicon-remove-sign"></span></a>
</div>
